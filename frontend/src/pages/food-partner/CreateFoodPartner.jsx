...
const CreateFood = () => {
    ...
    const onSubmit = async (e) => {
        ...
        navigate("/profile"); // Redirect to profile page to see the uploaded food
        // Optionally reset
        ...
        <div className="create-food-page">
            <div className="create-food-card">
                <header className="create-food-header">
                    <button 
                        className="back-button create-food-back-button"
                        onClick={() => navigate(-1)}
                        title="Go Back"
                    >
                        ← Back
                    </button>
                    <h1 className="create-food-title">Upload Reel</h1>
